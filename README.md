...
graph TD
    subgraph Monorepo [pnpm Workspace]
        ...
        subgraph Libs [Librerías / Paquetes Core]
            A[fa:fa-box @xavierdev25/rfc7807-errors]
            A_Desc(Filtros globales, Tipos y Excepciones<br>Estandarización IETF) -.-> A
        end
        
        subgraph Apps [Aplicaciones (Hexagonal Architecture)]
            B[fa:fa-server apps/enterprise-demo]
